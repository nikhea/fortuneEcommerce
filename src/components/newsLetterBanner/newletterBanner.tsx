...
const newletterBanner = () => {
  return (
    <div className=" h-[40vh]  top-0 left-0 right-0 bottom-0 overflow-hidden relative">
      <img
      ...
      <div className="container absolute top-0 bottom-0 left-0 right-0 z-10 flex flex-col items-center justify-center w-full h-full gap-y-5">
        <h6 className=" text-base md:text-lg lg:text-2xl font-bold text-white capitalize">
